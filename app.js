...
let sortedByBirthYear = inventors.sort((inventorNum1, inventorNum2) => {
    return inventorNum1.year - inventorNum2.year
})
// Complete the exercise in the space below:
...
let inventorNamedAda = inventors.find((inventorName) => {
    return inventorName.first === "Ada"
})
